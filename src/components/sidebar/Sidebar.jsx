...
export function Sidebar() {
    ...
    function toggleDetailsDialog(position, type) {
        setDialogDetails((prev) => {
        if (prev.open && prev.position === position && prev.type === type) {
          // If the same dialog is already open, close it
          return { open: false, position: '', type: '' };
        } else {
          // Otherwise, open the new dialog
          return { open: true, position, type };
        }
      });
    }
    ...
    return (
      <>
              ...
              <div className='workspace-container'>
                ...
                <div className='icons-container'>
                  <Button
                    ...
                    scale='ghost'
                    className='details'
                    onClick={(ev) => toggleDetailsDialog('top', 'workspace')}
                  >
                  ...
                  <StyledLink to='/'>
                    ...
                    <div className='icons-container'>
                      <Button
                        ...
                        scale='ghost'
                        className='details'
                        onClick={(ev) => toggleDetailsDialog('up', 'table')}
                      >
                  ...
                  <StyledLink to='/'>
                    ...
                    <div className='icons-container'>
                      <Button
                        ...
                        scale='ghost'
                        className='details'
                        onClick={(ev) => toggleDetailsDialog('middle', 'calendar')}
                      >
                        <Icon name='details' size='14px' />
                      </Button>
                    </div>
              ...
              <div className='workspace-container'>
                ...
                <div className='icons-container'>
                  <Button
                    ...
                    scale='ghost'
                    className='details'
                    onClick={() => toggleDetailsDialog('down', 'board')}
                  >
                    <Icon name='details' size='16px' />
                  </Button>
                  <Button
                  ...
                  <StyledLink to='/'>
                    ...
                    <div className='icons-container'>
                      <Button
                        ...
                        scale='ghost'
                        className='details'
                        onClick={() => toggleDetailsDialog('bottom', 'board')}
                      >
                        <Icon name='details' size='16px' />
                      </Button>
                      <Button
        ...
        {dialogDetails.open && (
            <DetailsDialog
                onToggle={toggleDetailsDialog}
                position={dialogDetails.position} 
